...
export default function InviteDialog({
  ...
  // Parse the textarea into a clean list of emails
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription>
          Send email invitations with a secure link to join the organisation. Links expire in 48 hours.
        </DialogDescription>
      </DialogHeader>
      ...
      <div className="space-y-4 py-2">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            <Label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              Email Addresses <span className="text-destructive normal-case">*</span>
            </Label>
            {emailCount > 0 && (
        ...
        <div className="rounded-xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 p-3.5 flex gap-2.5">
          ...
          <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
            Each recipient will receive a secure activation link. They'll set their own password when they accept the invitation.
          </p>
        </div>
      </div>
