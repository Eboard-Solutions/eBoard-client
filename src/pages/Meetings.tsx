      ...
      {!isLoading && (
        <Tabs defaultValue="upcoming" className="space-y-6">
          <TabsList className="bg-muted/50 p-1.5 h-auto rounded-lg gap-1.5 flex-wrap">
            <TabsTrigger value="upcoming" className="rounded-md data-[state=active]:bg-background data-[state=active]:shadow">
              Upcoming {upcoming.length > 0 && <Badge variant="secondary" className="ml-2 text-xs">{upcoming.length}</Badge>}
            </TabsTrigger>
            <TabsTrigger value="past" className="rounded-md data-[state=active]:bg-background data-[state=active]:shadow">
              Past {past.length > 0 && <Badge variant="secondary" className="ml-2 text-xs">{past.length}</Badge>}
            </TabsTrigger>
            <TabsTrigger value="calendar" className="rounded-md data-[state=active]:bg-background data-[state=active]:shadow">
              Calendar
            </TabsTrigger>
            <TabsTrigger value="agenda" className="rounded-md data-[state=active]:bg-background data-[state=active]:shadow flex items-center gap-1.5">
              <ClipboardList className="h-4 w-4" /> Agenda
            </TabsTrigger>
            <TabsTrigger value="minutes" className="rounded-md data-[state=active]:bg-background data-[state=active]:shadow flex items-center gap-1.5">
                  ...
                  >
                    <CardContent className="p-5">
                      <div className="flex gap-5 items-start">
                        <div className={`flex flex-col items-center justify-center w-20 h-20 rounded-2xl shrink-0 font-bold ${
